...
<template>
    <!-- Modal -->
    <div class="modal" id="showCar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="showCar" aria-hidden="true">
            ...
            <form @submit.prevent="sendData()">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <SecondaryButton data-bs-dismiss="modal" @click="clear()">Fechar</SecondaryButton>
                    </div>
                </div>
            </form>
        </div>
